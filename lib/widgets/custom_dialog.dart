      ...
      builder: (BuildContext context, Widget? child) {
        return ScaleTransition(
          ...
          child: Dialog(
            ...
            child: SizedBox(width: 380, child: dialogContent(context)),
          ),
        );
      },
    );
                ...
                children: <Widget>[
                  if (widget.topWidget != null)
                    Padding(
                      ...
                      child: SizedBox(
                        height: 60,
                        child: Center(child: widget.topWidget),
                      ),
                    ),
                  if (widget.title != '')
                    Padding(
  ...
  List<Widget> getActionButtonsList(BuildContext context) {
    if (widget.actionButtonList != null) {
      if (widget.actionButtonList!.length > 2 || widget.isVerical) {
        ...
        final List<Widget> list = <Widget>[];
        list.add(Expanded(child: widget.actionButtonList![0]));
        list.add(
          Container(
            width: 0.6,
            height: 48,
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Text(
          ...
          style: Theme.of(
            context,
          ).textTheme.bodyMedium!.copyWith(color: btnColor),
        ),
      ),
    );
  }
